/-
Construction of the corrected strong ordered central path from global simple
and guard estimates.
-/
...
namespace Zeta23.GapMatching.ConcreteStrongCentralPathD2
...
end Zeta23.GapMatching.ConcreteStrongCentralPathD2
