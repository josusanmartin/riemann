/-
Corrected eventual-witness packaging with threshold proofs explicit in every
large-height field.
-/
...
namespace Zeta23.GapMatching.EventualCentralFamilyD2
...
theorem EventualCentralConstruction.toCentralWordFamily
  ...
  error_small := by
    have heq : selectedError H =
      ...
      · simp [selectedError, selectedWord, hT, trivialWordAt,
          wordError, boundary, phi, A, B, p, j, badLeft]
    rw [heq]
    exact H.wordError_small

end Zeta23.GapMatching.EventualCentralFamilyD2
