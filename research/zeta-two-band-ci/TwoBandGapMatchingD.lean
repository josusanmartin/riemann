...
Height-dependent Montgomery--Taylor seam for the two-band finite-state bonus.
-/
...
/-- Minimal eventual two-band bonus. -/
structure EventualTwoBandBonusD
...
theorem thmD_mult2_gap_abstract
    ...
    (hgap : EventualTwoBandBonusD Z P energy error)
    (hTail : ∀ᶠ T in atTop,
...
theorem thmD_gap_lam_eventual
    ...
    (energy error : ℝ → ℝ)
    (hgap : EventualTwoBandBonusD zetaZeroConfig
